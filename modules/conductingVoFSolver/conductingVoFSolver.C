...
namespace solvers
{
    defineTypeNameAndDebug(conductingVoFSolver, 0);
}
}
...
void Foam::solvers::conductingVoFSolver::continuityErrors()
{
...
void Foam::solvers::conductingVoFSolver::setrAU(const fvVectorMatrix& UEqn)
{
    if (rAU.valid())
    {
        rAU() = 1.0/UEqn.A();
...
void Foam::solvers::conductingVoFSolver::clearrAU()
{
...
void Foam::solvers::conductingVoFSolver::correctCoNum()
{
...
Foam::solvers::conductingVoFSolver::conductingVoFSolver
(
    fvMesh& mesh,
...
Foam::scalar Foam::solvers::conductingVoFSolver::maxDeltaT() const
{
...
void Foam::solvers::conductingVoFSolver::preSolve()
{
    // Read the controls
    readControls();
...
void Foam::solvers::conductingVoFSolver::prePredictor()
{}


void Foam::solvers::conductingVoFSolver::postSolve()
{
    divU.clear();
}
