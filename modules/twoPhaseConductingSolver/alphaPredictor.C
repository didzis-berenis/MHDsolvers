...
Foam::tmp<Foam::surfaceScalarField> Foam::solvers::twoPhaseConductingSolver::alphaPhi
(
...
void Foam::solvers::twoPhaseConductingSolver::alphaSolve
(
    const dictionary& alphaControls
)
{
...
void Foam::solvers::twoPhaseConductingSolver::alphaPredictor()
{
